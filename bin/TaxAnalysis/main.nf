...
params.grp        = false
params.inPath     = false
params.OutPath    = "04.Taxonomy"

params.identcov   = ".cov.txt"
params.prefixcov  = "AvgDepth"
params.valuescov  = 1
params.keycov     = 0
...
if (params.help) {
    ...
    log.info " --tax        input Taxonomy Assign Result. Look Like This: SequenceID\tk__|p__|c__|o__|f__|g__|s__ [NotReady]                                  "
    log.info " --delimited  input Taxonomy Delimited [|]                                                                                                      "
    ...
    log.info " --OutPath    Quant Output Path                                [04.Taxonomy]                                                                    "
    log.info "                                                                                                                                                "
...
Channel.fromPath("$params.tax").into {covTax;pkmTax;kronaTax;lefseTaxcov;lefseTaxpkm}
...
process  krona{
    if (params.local) {
        ...
        executor "slurm"
        clusterOptions "${params.fN?'-p compute_R830':''} -x $params.xN -J Krona"
    }
    else {
        executor "slurm"
        clusterOptions "${params.fN?'-p compute_R830':''} -J Krona"
    }
    cpus 1
    memory 5
    errorStrategy 'retry'
    ...
    input:
        file kronatax from kronaTax
    
    output:
        file("Taxonomy.krona.Text")
        file("Taxonomy.krona.HTML")
        file("Taxonomy.krona.quant.HTML")
    
    script:
    """
    cat $kronatax | awk -F t '{print }' | sed 's/${params.delimited}/\\t/g' | sed -e 's/root*//g' | sed '/^\$/d' > Taxonomy.krona.Text
    perl ${source}/bin/Krona/KronaTools/scripts/ImportText.pl Taxonomy.krona.Text -o Taxonomy.krona.HTML
    perl ${source}/bin/Krona/KronaTools/scripts/ImportText.pl Taxonomy.krona.Text -o Taxonomy.krona.quant.HTML -q
    """
}
...
process  lefseCov{
    ...
    # -------------------- Make Filter Result >>>>>>>>>>>>>>>
    cat LEfSe_${params.prefixcov}/${params.prefixcov}.LEfSe.res | sed -e '/-/d' | sed '/Other/d' | sed '/Ambiguous/d' | sed '/unclassified/d' | sed -e '/\\.\\t/d' | sort -k3 -n > LEfSe_${params.prefixcov}/${params.prefixcov}.LEfSe.FLT.res
    python ${source}/bin/LEfSe-NextFlow/nsegata-lefse-82605a2ae7b7/plot_cladogram.py LEfSe_${params.prefixcov}/${params.prefixcov}.LEfSe.FLT.res LEfSe_${params.prefixcov}/${params.prefixcov}.LEfSe.FLT.cladogram.png --format png --dpi 100
    python ${source}/bin/LEfSe-NextFlow/nsegata-lefse-82605a2ae7b7/plot_cladogram.py LEfSe_${params.prefixcov}/${params.prefixcov}.LEfSe.FLT.res LEfSe_${params.prefixcov}/${params.prefixcov}.LEfSe.FLT.cladogram.pdf --format pdf
    python ${source}/bin/LEfSe-NextFlow/nsegata-lefse-82605a2ae7b7/plot_res.py       LEfSe_${params.prefixcov}/${params.prefixcov}.LEfSe.FLT.res LEfSe_${params.prefixcov}/${params.prefixcov}.LEfSe.FLT.png --format png --dpi 100
    python ${source}/bin/LEfSe-NextFlow/nsegata-lefse-82605a2ae7b7/plot_res.py       LEfSe_${params.prefixcov}/${params.prefixcov}.LEfSe.FLT.res LEfSe_${params.prefixcov}/${params.prefixcov}.LEfSe.FLT.pdf --format pdf
    cat LEfSe_${params.prefixcov}/${params.prefixcov}.LEfSe.FLT.res | sed '1iTaxonomy\\tHighest Mean\\tGroups(with Highest Mean)\\tLDA SCORE\\tP-Value' > LEfSe_${params.prefixcov}/${params.prefixcov}.LEfSe.FLT
    """
}
...
process  lefsePKM{
    ...
    python ${source}/bin/LEfSe-NextFlow/nsegata-lefse-82605a2ae7b7/plot_cladogram.py LEfSe_${params.prefixpkm}/${params.prefixpkm}.LEfSe.res LEfSe_${params.prefixpkm}/${params.prefixpkm}.LEfSe.cladogram.pdf --format pdf
    ...
    python ${source}/bin/LEfSe-NextFlow/nsegata-lefse-82605a2ae7b7/plot_res.py       LEfSe_${params.prefixpkm}/${params.prefixpkm}.LEfSe.res LEfSe_${params.prefixpkm}/${params.prefixpkm}.LEfSe.pdf --format pdf
    # -------------------- Make Filter Result >>>>>>>>>>>>>>>
    cat LEfSe_${params.prefixpkm}/${params.prefixpkm}.LEfSe.res | sed -e '/-/d' | sed '/Other/d' | sed '/Ambiguous/d' | sed '/unclassified/d' | sed -e '/\\.\\t/d' | sort -k3 -n > LEfSe_${params.prefixpkm}/${params.prefixpkm}.LEfSe.FLT.res
    python ${source}/bin/LEfSe-NextFlow/nsegata-lefse-82605a2ae7b7/plot_cladogram.py LEfSe_${params.prefixpkm}/${params.prefixpkm}.LEfSe.FLT.res LEfSe_${params.prefixpkm}/${params.prefixpkm}.LEfSe.FLT.cladogram.png --format png --dpi 100
    python ${source}/bin/LEfSe-NextFlow/nsegata-lefse-82605a2ae7b7/plot_cladogram.py LEfSe_${params.prefixpkm}/${params.prefixpkm}.LEfSe.FLT.res LEfSe_${params.prefixpkm}/${params.prefixpkm}.LEfSe.FLT.cladogram.pdf --format pdf
    python ${source}/bin/LEfSe-NextFlow/nsegata-lefse-82605a2ae7b7/plot_res.py       LEfSe_${params.prefixpkm}/${params.prefixpkm}.LEfSe.FLT.res LEfSe_${params.prefixpkm}/${params.prefixpkm}.LEfSe.FLT.png --format png --dpi 100
    python ${source}/bin/LEfSe-NextFlow/nsegata-lefse-82605a2ae7b7/plot_res.py       LEfSe_${params.prefixpkm}/${params.prefixpkm}.LEfSe.FLT.res LEfSe_${params.prefixpkm}/${params.prefixpkm}.LEfSe.FLT.pdf --format pdf
    cat LEfSe_${params.prefixpkm}/${params.prefixpkm}.LEfSe.FLT.res | sed '1i/Taxonomy\\tHighest Mean\\tGroups(with Highest Mean)\\tLDA SCORE\\tP-Value' > LEfSe_${params.prefixpkm}/${params.prefixpkm}.LEfSe.FLT
    """
}
...
process  krataxCOV{
    ...
    # BetaDiv
    # Heatmap PCoA/PCA
    mkdir Beta_${params.prefixcov}
    Rscript ${source}/bin/betadiv.r ${params.prefixcov}/RelativeAbundance/Kingdom_Dominant.xls Beta_${params.prefixcov} $params.smp $params.grp ${params.prefixcov}_Kingdom_Dominant
    Rscript ${source}/bin/betadiv.r ${params.prefixcov}/RelativeAbundance/Phylum_Dominant.xls  Beta_${params.prefixcov} $params.smp $params.grp ${params.prefixcov}_Phylum_Dominant
    Rscript ${source}/bin/betadiv.r ${params.prefixcov}/RelativeAbundance/Class_Dominant.xls   Beta_${params.prefixcov} $params.smp $params.grp ${params.prefixcov}_Class_Dominant
    Rscript ${source}/bin/betadiv.r ${params.prefixcov}/RelativeAbundance/Order_Dominant.xls   Beta_${params.prefixcov} $params.smp $params.grp ${params.prefixcov}_Order_Dominant
    Rscript ${source}/bin/betadiv.r ${params.prefixcov}/RelativeAbundance/Family_Dominant.xls  Beta_${params.prefixcov} $params.smp $params.grp ${params.prefixcov}_Family_Dominant
    Rscript ${source}/bin/betadiv.r ${params.prefixcov}/RelativeAbundance/Genus_Dominant.xls   Beta_${params.prefixcov} $params.smp $params.grp ${params.prefixcov}_Genus_Dominant
    Rscript ${source}/bin/betadiv.r ${params.prefixcov}/RelativeAbundance/Species_Dominant.xls Beta_${params.prefixcov} $params.smp $params.grp ${params.prefixcov}_Species_Dominant
    # PCA Euclidean Div
    Rscript ${source}/bin/taxpca.r ${params.prefixcov}/RelativeAbundance/Kingdom_Dominant.xls Beta_${params.prefixcov} $params.smp $params.grp ${params.prefixcov}_Kingdom_Dominant
    Rscript ${source}/bin/taxpca.r ${params.prefixcov}/RelativeAbundance/Phylum_Dominant.xls  Beta_${params.prefixcov} $params.smp $params.grp ${params.prefixcov}_Phylum_Dominant
    Rscript ${source}/bin/taxpca.r ${params.prefixcov}/RelativeAbundance/Class_Dominant.xls   Beta_${params.prefixcov} $params.smp $params.grp ${params.prefixcov}_Class_Dominant
    Rscript ${source}/bin/taxpca.r ${params.prefixcov}/RelativeAbundance/Order_Dominant.xls   Beta_${params.prefixcov} $params.smp $params.grp ${params.prefixcov}_Order_Dominant
    Rscript ${source}/bin/taxpca.r ${params.prefixcov}/RelativeAbundance/Family_Dominant.xls  Beta_${params.prefixcov} $params.smp $params.grp ${params.prefixcov}_Family_Dominant
    Rscript ${source}/bin/taxpca.r ${params.prefixcov}/RelativeAbundance/Genus_Dominant.xls   Beta_${params.prefixcov} $params.smp $params.grp ${params.prefixcov}_Genus_Dominant
    Rscript ${source}/bin/taxpca.r ${params.prefixcov}/RelativeAbundance/Species_Dominant.xls Beta_${params.prefixcov} $params.smp $params.grp ${params.prefixcov}_Species_Dominant
...
process  krataxPKM{
    ...
    output:
        ...
        file("Differential_${params.prefixpkm}")
        file("Beta_${params.prefixpkm}")
    ...
    # Heatmap PCoA/PCA
    # PCoA
    mkdir Beta_${params.prefixpkm}
    Rscript ${source}/bin/betadiv.r ${params.prefixpkm}/RelativeAbundance/Kingdom_Dominant.xls Beta_${params.prefixpkm} $params.smp $params.grp ${params.prefixpkm}_Kingdom_Dominant
    Rscript ${source}/bin/betadiv.r ${params.prefixpkm}/RelativeAbundance/Phylum_Dominant.xls  Beta_${params.prefixpkm} $params.smp $params.grp ${params.prefixpkm}_Phylum_Dominant
    Rscript ${source}/bin/betadiv.r ${params.prefixpkm}/RelativeAbundance/Class_Dominant.xls   Beta_${params.prefixpkm} $params.smp $params.grp ${params.prefixpkm}_Class_Dominant
    Rscript ${source}/bin/betadiv.r ${params.prefixpkm}/RelativeAbundance/Order_Dominant.xls   Beta_${params.prefixpkm} $params.smp $params.grp ${params.prefixpkm}_Order_Dominant
    Rscript ${source}/bin/betadiv.r ${params.prefixpkm}/RelativeAbundance/Family_Dominant.xls  Beta_${params.prefixpkm} $params.smp $params.grp ${params.prefixpkm}_Family_Dominant
    Rscript ${source}/bin/betadiv.r ${params.prefixpkm}/RelativeAbundance/Genus_Dominant.xls   Beta_${params.prefixpkm} $params.smp $params.grp ${params.prefixpkm}_Genus_Dominant
    Rscript ${source}/bin/betadiv.r ${params.prefixpkm}/RelativeAbundance/Species_Dominant.xls Beta_${params.prefixpkm} $params.smp $params.grp ${params.prefixpkm}_Species_Dominant
    # PCA Euclidean Div
    Rscript ${source}/bin/taxpca.r ${params.prefixpkm}/RelativeAbundance/Kingdom_Dominant.xls Beta_${params.prefixpkm} $params.smp $params.grp ${params.prefixpkm}_Kingdom_Dominant
    Rscript ${source}/bin/taxpca.r ${params.prefixpkm}/RelativeAbundance/Phylum_Dominant.xls  Beta_${params.prefixpkm} $params.smp $params.grp ${params.prefixpkm}_Phylum_Dominant
    Rscript ${source}/bin/taxpca.r ${params.prefixpkm}/RelativeAbundance/Class_Dominant.xls   Beta_${params.prefixpkm} $params.smp $params.grp ${params.prefixpkm}_Class_Dominant
    Rscript ${source}/bin/taxpca.r ${params.prefixpkm}/RelativeAbundance/Order_Dominant.xls   Beta_${params.prefixpkm} $params.smp $params.grp ${params.prefixpkm}_Order_Dominant
    Rscript ${source}/bin/taxpca.r ${params.prefixpkm}/RelativeAbundance/Family_Dominant.xls  Beta_${params.prefixpkm} $params.smp $params.grp ${params.prefixpkm}_Family_Dominant
    Rscript ${source}/bin/taxpca.r ${params.prefixpkm}/RelativeAbundance/Genus_Dominant.xls   Beta_${params.prefixpkm} $params.smp $params.grp ${params.prefixpkm}_Genus_Dominant
    Rscript ${source}/bin/taxpca.r ${params.prefixpkm}/RelativeAbundance/Species_Dominant.xls Beta_${params.prefixpkm} $params.smp $params.grp ${params.prefixpkm}_Species_Dominant
    # Differential Analysis
